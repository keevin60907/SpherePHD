...
class SpherePHD():
    ...
    def autoencoder(self, subdivision):
        ...
        self.Y = tf.placeholder(tf.float32, [None, 1, 20 * 4**subdivision, NUM_CLASS])
    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            self.print_test(sess)
        print('Model saved in path: %s' % save_path)
        print('Training finish')

    def print_test(self, sess):
        ...
        print('Testing accuracy is {:.2f}%'.format(total_accuracy/100))
